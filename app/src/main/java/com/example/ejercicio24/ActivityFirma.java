...
public class ActivityFirma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnFotoTakePhoto = (Button) findViewById(R.id.btnFotoTakePhoto);
        Button btnFotoGuardar = (Button) findViewById(R.id.btnFotoGuardar);
        txtDescripcion = (EditText) findViewById(R.id.txtDescripcion);

        btnFotoTakePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnFotoGuardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bitmap bitmap;
                try {
                    bitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), fotoUri);
                    if(txtDescripcion.getText().toString().isEmpty() || fotoUri == null){
                        Toast.makeText(getApplicationContext(), "Se necesita el completar todos los campos", Toast.LENGTH_LONG).show();
                    }else{
    ...
    private void tomarFoto(){
        ...
        if (Intenttakephoto.resolveActivity(getPackageManager()) != null){
            ...
            if (foto!= null){
                fotoUri = FileProvider.getUriForFile(this, "com.example.ejercicio24.fileprovider",foto);
    ...
    private void guardarImagen(Bitmap bitmap, String decripcion) {
        ...
        byte[] imgInset = imagemComprimida(blob);

        String sql = "INSERT INTO signaturess (firmaDigital,descripcion) VALUES(?,?)";
    ...
    private byte[] imagemComprimida(byte[] imagem_img){
